 ...
 *
 ****
 **** This is a pure C implementation of the standard C++ f-Wave solver
 *(FWave.hpp).
 ****
 *
...
__device__ void fWaveComputeNetUpdates(const T i_gravity, T i_hLeft, T i_hRight, T i_huLeft, T i_huRight, T i_bLeft,
                                       T i_bRight,

                                       T o_netUpdates[5]);

__device__ inline void fWaveComputeWaveSpeeds(const T i_gravity, const T i_hLeft, const T i_hRight, const T i_huLeft,
                                              const T i_huRight, const T i_uLeft, const T i_uRight, const T i_bLeft,
                                              const T i_bRight,

                                              T o_waveSpeeds[2]);

__device__ inline void fWaveComputeWaveDecomposition(const T i_gravity, const T i_hLeft, const T i_hRight,
                                                     const T i_huLeft, const T i_huRight, const T i_uLeft,
                                                     const T i_uRight, const T i_bLeft, const T i_bRight,
 ...
 *   0: hUpdateLeft   - Net-update for the height of the cell on the left side
 * of the edge. 1: hUpdateRight  - Net-update for the height of the cell on the
 * right side of the edge. 2: huUpdateLeft  - Net-update for the momentum of the
 * cell on the left side of the edge 3: huUpdateRight - Net-update for the
 * momentum of the cell on the right side of the edge. 4: maxWaveSpeed  -
 * Maximum (linearized) wave speed -> Should be used in the CFL-condition.
 *
 * TODO: A wet/wet state is assumend / no boundaries are implemented within the
 * solver to allow an execution with with a few jumps only.
 *
                                       ...
                                       T o_netUpdates[5])
{
    ...
    fWaveComputeWaveSpeeds(i_gravity, i_hLeft, i_hRight, i_huLeft, i_huRight, uLeft, uRight, i_bLeft, i_bRight,
    ...
    fWaveComputeWaveDecomposition(i_gravity, i_hLeft, i_hRight, i_huLeft, i_huRight, uLeft, uRight, i_bLeft, i_bRight,
